                    ...
                    <div class="card card-primary card-outline card-outline-tabs">
                        <div class="card-header p-0 border-bottom-0">
                            <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="custom-tabs-four-home-tab" data-toggle="pill" href="#custom-tabs-four-home" role="tab" aria-controls="custom-tabs-four-home" aria-selected="true">Товар</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="custom-tabs-four-profile-tab" data-toggle="pill" href="#custom-tabs-four-profile" role="tab" aria-controls="custom-tabs-four-profile" aria-selected="false">Аукцион</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">

                            <!-- new place form on 2 tabs -->
                            ...
                            <div class="tab-content" id="custom-tabs-four-tabContent">
                                    ...
                                    <!--<div class="col-12">-->
                                        <div class="card ">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <!-- above finish form & buttons save cancel -->
                                ...
                                <div class="tab-pane fade" id="custom-tabs-four-profile" role="tabpanel" aria-labelledby="custom-tabs-four-profile-tab">
                                    ...
                                    <div class="card ">
                                        <div class="card-header ">
                                            <h5 class="m-0">Данные Аукциона</h5>
                                        </div>
                                        <div class="card-body">
                                            <div class="d-flex mt-5">
                                                <div class="form-group col-4">
                                            ...
                                            <div class="d-flex mt-5">
                                                <div class="form-group col-4">
                                                    <label>Товар новинка</label>
                                                    <div class="custom-control custom-checkbox">
                                                        <input class="custom-control-input" name="auction_new" type="checkbox" value="1" id="auction_new"
                                                               {{ (old('auction_new') == 1) ? ' checked ' : '' }}
                                                               @isset($product) @if($product->auction_new == 1) checked @endif @endisset
                                                        >
                                                        <label class="custom-control-label" for="auction_new">Новинка</label>
                                                    </div>
                                                </div>

                                                <div class="form-group col-2">
                                                    <label for="auction_rating"> Рейтинг </label>
                                                    <select class="form-control" name="auction_rating" id="auction_rating">
                                                        <option disabled selected value="" >выберите рейтинг</option>
                                                        @foreach([1,2,3,4,5] as $rating)
                                                            @if(old('auction_rating') == $rating)
                                                                <option value="{{ old('auction_rating') }}" selected >{{ $rating }}</option>
                                                            @else
                                                                <option value="{{ $rating }}" {{ (isset($product->auction_rating) && $product->auction_rating == $rating ) ? 'selected' : '' }}> {{ $rating }} </option>
                                                            @endif
