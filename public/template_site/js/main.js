    ...
    new Vue({
        ...
        mounted: function() {
            ...
            if ($('.thanks__inner').length) {
                ...
                $.each(this.basket, function (index, product) {
                    fcontents.push({
                        'id': product.art,
        ...
        methods: {
            ...
            countTotal: function () {
                ...
                $.each(that.basket, function (index, product) {
                    ...
                    that.total += parseInt(product.sale); 
                });

                that.$cookies.set('basket', JSON.stringify(that.basket));

                if (that.order.promocodeAccepted) {
                    that.total = that.total - parseInt(50);
                }
            },
            ...
            addToCart: function (product, event) {
                ...
                this.basket.push({
                    qty:      1,
                    art:      product.active50 ? product.art50   : product.art100,
                    price:    product.price,
